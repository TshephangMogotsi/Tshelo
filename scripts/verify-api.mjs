...
const unauthenticatedCases = [
  ...
  ['list event guests', 'GET', `/api/v1/events/${TEST_UUID}/guests`],
  ['invite event guests', 'POST', `/api/v1/events/${TEST_UUID}/guests`],
  ['get event guest', 'GET', `/api/v1/events/${TEST_UUID}/guests/${TEST_UUID}`],
  ['update event guest', 'PATCH', `/api/v1/events/${TEST_UUID}/guests/${TEST_UUID}`],
  ['remove event guest', 'DELETE', `/api/v1/events/${TEST_UUID}/guests/${TEST_UUID}`],
  ['get my event RSVP', 'GET', `/api/v1/events/${TEST_UUID}/rsvp`],
  ['respond to event RSVP', 'PUT', `/api/v1/events/${TEST_UUID}/rsvp`],
  ['get event guest capacity', 'GET', `/api/v1/events/${TEST_UUID}/guest-capacity`],
  ['unlock event guest capacity', 'POST', `/api/v1/events/${TEST_UUID}/guest-capacity`],
