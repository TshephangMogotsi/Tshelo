-- Event-only creation already supports a named "Other" event. Bring the
-- atomic Event + Fund transaction into parity by validating a safe custom
-- label instead of restricting the value to preset identifiers.
